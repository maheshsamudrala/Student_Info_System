...
public class StudentEditDao {
	...
	public String EditDetails(StudentEdit edit)
	{
		try
		{
			...
			editQuery = "UPDATE student SET student_phoneno = '"+edit.getPhone()+"', student_address ='"+edit.getAddress()+"' WHERE student_rollno='1'";
			editStmt.executeUpdate(editQuery);
			System.out.println(edit.getPhone());
			
			Statement pwdStmt= con.createStatement();
			pwdQuery="UPDATE login SET password='"+edit.getPassword()+"' WHERE login_id='1'";
