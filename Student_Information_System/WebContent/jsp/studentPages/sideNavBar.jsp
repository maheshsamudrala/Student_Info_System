...
<ul class="nav nav-pills nav-stacked">
     <li  class="active"><a href="StudentHomePageAction"><i class="fa fa-home "></i>&nbsp;Home</a></li>
...
<div class="frame1">
<ul class="nav nav-pills nav-stacked">
     <li  class="active"><a href="interest"><i  class="fa fa-gears"></i>&nbsp;Profile Settings</a></li>
