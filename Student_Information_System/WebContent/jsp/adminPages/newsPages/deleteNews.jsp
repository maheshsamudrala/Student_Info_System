	...
	<div class="col-lg-7">
		...
		<s:set name="msg" value="message"/>
  		<s:if test="%{#msg=='success'}">
  			<h3 align="center">News Deleted Successfully</h3><br><br>
  		</s:if>
  		<s:else>
  		<h3 align="center"><label class="control-label"><s:property value="msg"/> </label></h3>	<br><br>		
  		</s:else>
		<form class="form-horizental" action="deleteNews" method="post" >
  				<div class="form-group">
      				<label  class="col-lg-4 control-label">News ID</label> 
     				 <div class="col-lg-4">
							<input type="text" class="form-control" placeholder="Type News ID here" name="id" >     			 		
      				</div>
     			  <br><br>
   				 </div>
     			 ...
     			 <br><br><br><br>
   				  <div class="form-group">
      						<div class="col-lg-10 col-lg-offset-4"><input type="submit" value="Delete"  class="btn btn-primary" />
